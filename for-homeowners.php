...
<!-- Section 1: Hero Banner -->
    ...
    <section style="padding: 96px 24px;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 32px; max-width: 1200px; margin: auto;">
        <div class="card"><img src="<?= BASE_URL ?>/assets/apartment.jpg" alt="Apartment"><h3>Apartments</h3><p>Space-efficient solutions designed for urban apartment living.</p></div>
        <div class="card"><img src="<?= BASE_URL ?>/assets/villa.jpg" alt="Villa"><h3>Villas</h3><p>Elegant, scalable solutions for luxurious villa living.</p></div>
        <div class="card"><img src="<?= BASE_URL ?>/assets/farmhouse.jpg" alt="Farmhouse"><h3>Farmhouses</h3><p>Seamless control and comfort, even in remote locations.</p></div>
        <div class="card"><img src="<?= BASE_URL ?>/assets/bungalow.jpg" alt="Bungalow"><h3>Bungalows</h3><p>Sophisticated, integrated automation solutions for bungalows.</p></div>
      </div>
    </section>
    ...
    <section style="padding: 96px 24px; display: flex; flex-wrap: wrap; gap: 32px; justify-content: center; max-width: 1200px; margin: auto;">
      <div class="highlight-box">
        <img src="<?= BASE_URL ?>/icons/retrofit-icon.svg" alt="Retrofit" style="height: 48px;">
        <h3>Retrofit</h3>
        <p>Upgrade your existing home easily with minimal disruption.</p>
      </div>
      <div class="highlight-box">
        <img src="<?= BASE_URL ?>/icons/newbuild-icon.svg" alt="New Build" style="height: 48px;">
        <h3>New Build</h3>
    ...
    <section style="padding: 96px 24px; max-width: 1000px; margin: auto;">
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <div class="scenario"><img src="<?= BASE_URL ?>/icons/elderly-icon.svg" alt="Elderly"><div><h3>Elderly & Assisted Living</h3><p>Smart solutions ensuring safety, ease of access, and independence.</p></div></div>
        <div class="scenario"><img src="<?= BASE_URL ?>/icons/family-icon.svg" alt="Family"><div><h3>Family & Kids</h3><p>Enhanced home safety and easy monitoring, giving parents peace of mind.</p></div></div>
        <div class="scenario"><img src="<?= BASE_URL ?>/icons/travel-icon.svg" alt="Travel"><div><h3>Frequent Travelers</h3><p>Remote home monitoring and automation to manage your home securely from anywhere.</p></div></div>
      </div>
    </section>
    ...
    <section style="padding: 96px 24px; display: flex; flex-wrap: wrap; align-items: center; gap: 48px; background: rgba(255,255,255,0.02);">
      ...
      <div style="flex: 1 1 35%; min-width: 280px;">
        <img src="<?= BASE_URL ?>/assets/family-consultation.jpg" alt="Family Consultation" style="width: 100%; border-radius: 16px;">
      </div>
    </section>
