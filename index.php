...
$page_title = 'Luxury Smart Home Automation | iSwift in Delhi NCR';
$active_nav = 'Home';
$base_path = '';
$body_attrs = ' style="background-color:#FFF8F0;color:#5A4033;"';
$extra_head = <<<HTML
<meta name="description"
    content="iSwift delivers premium smart home solutions—smart lighting, security, curtains, and Wi-Fi mesh—for luxurious living in Delhi, Gurgaon, Noida, Ghaziabad, Greater Noida & Delhi NCR.">
<meta name="keywords"
    content="smart home automation, luxury smart home, smart lighting, home security, smart curtains, home Wi-Fi solutions, Delhi, Gurgaon, Noida, Ghaziabad, Greater Noida">
HTML;
include __DIR__ . '/partials/header.php';
?>
<!-- Section 1: Hero Banner -->
  <section
    style="position: relative; height: 100vh; background-image: url('/assets/images/hero-luxury-living-room.png'); background-size: cover; background-position: center;">
    <div
  ...
  <section style="padding: 96px 24px; text-align: center;">
    ...
    <div
      ...
      <!-- Cards Start -->
      <a href="/solutions/smart_lighting_control_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-lighting.png" alt="Lighting">
        <h3>Smart Lighting</h3>
        <p>Ambiance and energy savings.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_curtains_blinds_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-curtains.png" alt="Curtains">
        <h3>Smart Curtains & Blinds</h3>
        <p>Privacy and comfort automated.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_switches_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-switches.png" alt="Switches">
        <h3>Smart Switches & Panels</h3>
        <p>Control appliances intelligently.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_door_locks_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-locks.png" alt="Door Locks">
        <h3>Smart Door Locks</h3>
        <p>Secure keyless entry.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/video_door_systems_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-video-door-phone.png" alt="Door Systems">
        <h3>Video Door Systems</h3>
        <p>Talk to visitors safely.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_cameras_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-cameras.png" alt="Cameras">
        <h3>Smart Cameras</h3>
        <p>Real-time monitoring.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_sensors_alarms_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-sensors-alarms.png" alt="Sensors">
        <h3>Sensors & Alarms</h3>
        <p>Instant safety alerts.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_gate_automation_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-smart-gate.png" alt="Gate Automation">
        <h3>Smart Gate Automation</h3>
        <p>Automated entry/exit.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/wifi_mesh_network_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-wifi-mesh.png" alt="Wi-Fi">
        <h3>Wi-Fi Mesh Networks</h3>
        <p>Stable connectivity.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart_water_controller_page.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-water-controller.png" alt="Water Controller">
        <h3>Smart Water Controller</h3>
        <p>Prevent overflow.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/integrated_scenes_modes_page.php" class="card"
        style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-integrated-scenes.png" alt="Scenes">
        <h3>Integrated Scenes & Modes</h3>
        <p>Personalized automation.</p>
        <span style="color: #C45A34; font-weight: 500;">Know More</span>
      </a>
      <a href="/solutions/smart-air-purifier.php" class="card" style="text-decoration: none; color: inherit;">
        <img src="/assets/images/icon-air-purifier.png" alt="Scenes">
  ...
  <section style="padding: 96px 24px; text-align: center;">
    ...
    <div
      ...
      <div class="card"><img src="/assets/images/icon-convenience.png" alt="Convenience" style="height: 48px;">
        <h3>Convenience</h3>
        <p>Control lighting, security, curtains—all from one app or voice.</p>
      </div>
      <div class="card"><img src="/assets/images/icon-security.png" alt="Security">
        <h3>Security</h3>
        <p>Know your home is always safe, even when you’re away.</p>
      </div>
      <div class="card"><img src="/assets/images/icon-energy-efficiency.png" alt="Energy">
        <h3>Energy Efficiency</h3>
        <p>Intelligent systems reduce energy usage and costs automatically.</p>
      </div>
      <div class="card"><img src="/assets/images/icon-luxury-comfort.png" alt="Luxury">
  ...
  <section style="padding: 96px 24px; text-align: center;">
    ...
    <div style="max-width: 1000px; margin: auto;">
      <img src="/assets/images/transformation-before-after-combined.png" alt="Before and After Smart Home"
  ...
  <section style="padding: 96px 24px; width: 75%; margin: auto;">
    <div
      ...
      <img src="/assets/images/partner-callout.png" alt="Partner Meeting"
  ...
  <section style="padding: 96px 24px; text-align: center;">
    ...
    <div style="position: relative; max-width: 1000px; margin: auto;">
      <a href="#">
        <img src="/assets/images/featured-blog.png" alt="Smart Home Trends" style="width: 100%; border-radius: 16px;">
        <div
