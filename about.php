...
<!-- Section 1: Hero Banner -->
    <section style="position: relative; height: 60vh; background-image: url('<?= BASE_URL ?>/assets/about-hero.jpg'); background-size: cover; background-position: center;">
    ...
    <section style="display: flex; flex-wrap: wrap; align-items: center; padding: 96px 24px; gap: 48px;">
      ...
      <div style="flex: 1 1 35%; min-width: 280px;">
        <img src="<?= BASE_URL ?>/assets/brand-evolution.jpg" alt="Brand Evolution" style="width: 100%; border-radius: 16px;">
      </div>
    </section>
    ...
    <section style="padding: 96px 24px;">
      <div style="display: flex; flex-wrap: wrap; gap: 32px; justify-content: center;">
        <div class="card" style="background: rgba(255,255,255,0.04); border-radius: 16px; padding: 24px; flex: 1 1 300px; max-width: 400px; text-align: center;">
          <img src="<?= BASE_URL ?>/icons/eye-icon.svg" alt="Vision" style="height: 48px; margin-bottom: 16px;">
          <h3>Our Vision</h3>
          <p>To redefine luxury living through intelligent automation, creating comfortable, secure, and elegant homes.</p>
        </div>
        <div class="card" style="background: rgba(255,255,255,0.04); border-radius: 16px; padding: 24px; flex: 1 1 300px; max-width: 400px; text-align: center;">
          <img src="<?= BASE_URL ?>/icons/compass-icon.svg" alt="Mission" style="height: 48px; margin-bottom: 16px;">
          <h3>Our Mission</h3>
    ...
    <section style="padding: 96px 24px; text-align: center;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 32px; max-width: 1000px; margin: auto;">
        <div><img src="<?= BASE_URL ?>/icons/bulb-icon.svg" alt="Innovation" style="height: 48px;"><h3>Innovation</h3><p>Always embracing new technologies and smarter solutions.</p></div>
        <div><img src="<?= BASE_URL ?>/icons/shield-check-icon.svg" alt="Reliability"><h3>Reliability</h3><p>Consistently delivering on promises, ensuring peace of mind.</p></div>
        <div><img src="<?= BASE_URL ?>/icons/diamond-icon.svg" alt="Luxury"><h3>Luxury</h3><p>Maintaining the highest standards in elegance and comfort.</p></div>
        <div><img src="<?= BASE_URL ?>/icons/handshake-icon.svg" alt="Integrity"><h3>Integrity</h3><p>Building trust through transparency and ethical practices.</p></div>
      </div>
    </section>
    ...
    <section style="display: flex; flex-wrap: wrap; align-items: center; padding: 96px 24px; gap: 48px;">
      ...
      <div style="flex: 1 1 35%; min-width: 280px;">
          <img src="<?= BASE_URL ?>/assets/consulting-scene.jpg" alt="iSwift Consulting" style="width: 100%; border-radius: 16px;">
      </div>
    </section>
    ...
    <section style="padding: 96px 24px; text-align: center;">
      ...
      <div class="logo-slider" style="display: flex; overflow-x: auto; gap: 48px; padding-bottom: 16px;">
        <img src="<?= BASE_URL ?>/logos/yale.png" alt="Yale" style="height: 48px; filter: grayscale(100%); transition: filter 0.3s;">
        <img src="<?= BASE_URL ?>/logos/godrej.png" alt="Godrej" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/qubo.png" alt="Qubo" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/tplink.png" alt="TP-Link" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/netgear.png" alt="Netgear" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/alexa.png" alt="Alexa" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/google-home.png" alt="Google Home" style="height: 48px; filter: grayscale(100%);">
        <img src="<?= BASE_URL ?>/logos/siri.png" alt="Siri" style="height: 48px; filter: grayscale(100%);">
      </div>
